...
namespace GGTeam\BlogBundle\DependencyInjection\Compiler;
...
class RegisterMappingsPass implements CompilerPassInterface
{
    ...
    public static function createOrmMappingDriver(array $mappings)
    {
        ...
        return new RegisterMappingsPass($driver, 'doctrine.orm.%s_metadata_driver', $mappings, 'gg_team_blog.backend_type_orm', 'doctrine.default_entity_manager');
    }
    ...
    public static function createMongoDBMappingDriver($mappings)
    {
        ...
        return new RegisterMappingsPass($driver, 'doctrine_mongodb.odm.%s_metadata_driver', $mappings, 'gg_team_blog.backend_type_mongodb', 'doctrine_mongodb.odm.default_document_manager');
    }
    ...
    public static function createCouchDBMappingDriver($mappings)
    {
        ...
        return new RegisterMappingsPass($driver, 'doctrine_couchdb.odm.%s_metadata_driver', $mappings, 'gg_team_blog.backend_type_couchdb', 'doctrine_couchdb.default_document_manager');
    }
}